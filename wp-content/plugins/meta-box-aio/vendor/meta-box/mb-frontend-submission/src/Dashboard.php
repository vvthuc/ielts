			...
			<?php while( $this->query->have_posts() ) : $this->query->the_post(); ?>
				<tr>
					...
					<td align="center" class="mbfs-actions">
						<?php
							$edit_action = '<a href="' . esc_url( add_query_arg( 'rwmb_frontend_field_post_id', get_the_ID(), $this->edit_page_atts['url'] ) ) . '" title="' . esc_html( 'Edit', 'mb-frontend-submission' ) .'"><img src="' . MBFS_URL . 'assets/pencil.svg"></a>';
