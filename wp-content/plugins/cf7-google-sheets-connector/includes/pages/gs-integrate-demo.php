...
<div class="cf7_pro_demo">
			...
			<div class="cd-faq-content" style="display: block;">
				<div class="gs-demo-fields gs-second-block">
					<p>
					  <a class="cf_pro_link" target="_blank" href="<?php echo "https://cf7demo.gsheetconnector.com/" ?>"><label><?php echo esc_html( __( 'Click Here Demo', 'gsconnector' ) ); ?></label></a>
					...
					<a href="https://www.gsheetconnector.com/cf7-gsheetconnector-features" target="_blank"><h3>CF7 Google Sheet Connector PRO Features </h3></a>
