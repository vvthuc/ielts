...
define( 'GS_CONNECTOR_VERSION', '5.0.0' );
define( 'GS_CONNECTOR_DB_VERSION', '5.0.0' );
...
?>         	  
 ...
 <input type="text" name="gs-code" id="gs-code" value="" disabled placeholder="<?php echo esc_html(__('Currently Active', 'gsconnector')); ?>"/>
            ...
            <?php } else {
                ...
                ?>
               <input type="text" name="gs-code" id="gs-code" value="<?php echo $cf7gsc_code; ?>" placeholder="<?php echo esc_html(__('Enter Code', 'gsconnector')); ?>"/>
