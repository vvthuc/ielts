<footer class="bg-[#FFD602] lg:py-[2rem] py-[1.5rem] lg:pb-0">
    <div class="container px-3 mx-auto lg:pb-[2rem] pb-[1.5rem]">
        <a href="<?php echo site_url(); ?>" title="<?php echo bloginfo(); ?>" class="block mx-auto w-fit lg:mb-[1.875rem]">
        ...
        <?php if (!empty($branchs)) : ?>
                ...
                <?php foreach ($branchs as $k => $branch) : ?>
                    <div class="col-span-1">
                        <div class="item-branch">
                            <p class="title font-bold lg:text-[1.5rem] text-[1.25rem] text-blue mb-2">
            ...
            <?php endif; ?>
            <div class="col-span-1">
                <a href="tel:<?php echo mb_option("hotline"); ?>" title="<?php echo mb_option("hotline"); ?>" class="w-fit block hotline title font-bold lg:text-[1.5rem] text-[1.25rem] text-blue">Hotline <?php echo mb_option("hotline"); ?></a>
                <div class="fanpage"></div>
            </div>
            </div>
    </div>
    <div class="copy-right bg-[#fff] lg:py-[1.25rem] py-[0.9375rem]">
