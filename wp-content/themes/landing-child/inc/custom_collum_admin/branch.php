...
add_action( 'admin_init', function() {
	if (class_exists('MB_ADMIN_COLUMNS_POST')) {
    	class ADMIN_COLUMNS_BRANCH_MBAC extends MB_ADMIN_COLUMNS_POST { 
    	}
	} elseif (class_exists('\MBAC\Post')) {
    	class ADMIN_COLUMNS_BRANCH_MBAC extends \MBAC\Post {
    	}
	}
	class Branch_Custom_Admin extends ADMIN_COLUMNS_BRANCH_MBAC {
	...
	new Branch_Custom_Admin( 'branch', array() );
