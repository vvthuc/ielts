<?php
class Wg_Introduce extends WP_Widget
{
    /**
...
?>
        <section class="section-all" style="background: url(<?php echo get_stylesheet_directory_uri(); ?>/theme/frontend/images/cham-bi.jpg) no-repeat bottom right;background-size:contain;">
            <div class="container">
                <div class="row">
