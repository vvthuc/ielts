...
?>
        <section class="section-all section-new__index" style="background-color: #e6e6e647;background-repeat: no-repeat;background: url(<?php echo get_stylesheet_directory_uri(); ?>/theme/frontend/images/left-news.png)  no-repeat bottom -155px left -55px,url(<?php echo get_stylesheet_directory_uri(); ?>/theme/frontend/images/right-news.png)  no-repeat top -155px right -55px;background-size: contain;">
            <div class="container">
                <div class="row">
                    <?php
                    global $post;
