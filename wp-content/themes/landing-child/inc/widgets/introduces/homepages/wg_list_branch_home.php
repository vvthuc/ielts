                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex align-items-center wow fadeInLeft">
                        ...
                        <div class="module-branch__content">
                            ...
                            <p class="title-big__all f-bold cl-title fz-26 mb-3"><?php echo $title ?? ''; ?></p>
                            ...
                            <a href="<?php echo $link ?? ''; ?>" title="Xem chi tiết" class="btn btn-orange__all btn-hover mb-4 btn__scroll">Xem chi tiết</a>
                                        ...
                                        <div class="col-sm-4 mb-2 mb-sm-0">
                                            ...
                                            <div class="statis-item">
                                                ...
                                                <p class="number f-bold fz-30 mb-1">
                                                    ...
                                                    <span class="count" tech5s-number="05"> <?php echo _cget('number', $item); ?></span>

                                                </p>

                                                <p class="text"><?php echo wpautop(nl2br(_cget('content', $item))); ?></p>
