...
var summerHtmlImageMapCreator = (function() {
    ...
    Rectangle.prototype.toHTMLMapElementString = function() {
        ...
        return '<area shape="rect" data-fancybox-vector data-href="'+(this._attributes.title ?this._attributes.title :'')+'" coords="' // TODO: use template engine
            + this._coords.x + ', '
            + this._coords.y + ', '
            + x2 + ', '
            + y2
    ...
    Circle.prototype.toHTMLMapElementString = function() {
        return '<area shape="circle" data-fancybox-vector data-href="'+(this._attributes.title ?this._attributes.title :'')+'" coords="'
            + this._coords.cx + ', '
            + this._coords.cy + ', '
            + this._coords.radius
            + '"'
    ...
    Polygon.prototype.toHTMLMapElementString = function() {
        ...
        return '<area shape="poly" data-fancybox-vector data-href="'+(this._attributes.title ?this._attributes.title :'')+'" coords="'
            + str
            + '"'
            + (this._attributes.href ? ' href="' + this._attributes.href + '"' : '')
            + (this._attributes.alt ? ' alt="' + this._attributes.alt + '"' : '')
